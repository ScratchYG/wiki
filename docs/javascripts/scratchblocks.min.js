...
var scratchblocks = (function () {
    ...
    */
    ...
    // TODO define
    {
      ...
      id: "scratchyg.whenInitializedSDK",
      spec: "When Yandex.Games SDK loaded",
      inputs: [],
      shape: "hat",
      category: "scratchyg"
    }, {
      id: "scratchyg.initsdk",
      spec: "Load Yandex.Games SDK",
      inputs: [],
      shape: "stack",
      category: "scratchyg"
    }, {
      id: "scratchyg.setdebug",
      spec: "Enable debug mode",
      inputs: [],
      shape: "stack",
      category: "scratchyg"
    }, {
      id: "scratchyg.sdkenabled",
      spec: "Yandex.Games SDK loaded?",
      inputs: [],
      shape: "boolean",
      category: "scratchyg"
    }, {
      id: "scratchyg.savevars",
      spec: "Save progress",
      inputs: [],
      shape: "stack",
      category: "scratchyg"
    }, {
      id: "scratchyg.loadvars",
      spec: "Load progress",
      inputs: [],
      shape: "stack",
      category: "scratchyg"
    }, {
      id: "scratchyg.resetprogress",
      spec: "Reset progress",
      inputs: [],
      shape: "stack",
      category: "scratchyg"
    }, {
      id: "scratchyg.setsavedvar",
      spec: "Set variable %1 to %2",
      inputs: ["%s", "%s"],
      shape: "stack",
      category: "scratchyg"
    }, {
      id: "scratchyg.dataloaded",
      spec: "Progress loaded?",
      inputs: [],
      shape: "boolean",
      category: "scratchyg"
    }, {
      id: "scratchyg.getsavedvar",
      spec: "Get saved variable %1, defaults to %2",
      inputs: ["%s", "%s"],
      shape: "reporter",
      category: "scratchyg"
    }, {
      id: "scratchyg.whenFullscreenClosed",
      spec: "When Fullscreen ad closed",
      inputs: [],
      shape: "hat",
      category: "scratchyg"
    }, {
      id: "scratchyg.showfullscreen",
      spec: "Show Fullscreen ad",
      inputs: [],
      shape: "stack",
      category: "scratchyg"
    }, {
      id: "scratchyg.fullscreenClosed",
      spec: "is Fullscreen ad closed?",
      inputs: [],
      shape: "boolean",
      category: "scratchyg"
    }, {
      id: "scratchyg.whenRewardedWatched",
      spec: "When Rewarded ad closed",
      inputs: [],
      shape: "hat",
      category: "scratchyg"
    }, {
      id: "scratchyg.showrewarded",
      spec: "Show Rewarded ad",
      inputs: [],
      shape: "stack",
      category: "scratchyg"
    }, {
      id: "scratchyg.rewardedRewarded",
      spec: "is Rewarded ad rewarded?",
      inputs: [],
      shape: "boolean",
      category: "scratchyg"
    }, {
      id: "scratchyg.canRateGame",
      spec: "Can rate game?",
      inputs: [],
      shape: "boolean",
      category: "scratchyg"
    }, {
      id: "scratchyg.openRatePopup",
      spec: "Open rating popup",
      inputs: [],
      shape: "stack",
      category: "scratchyg"
    }, {
      id: "scratchyg.getDeviceType",
      spec: "User device type",
      inputs: [],
      shape: "reporter",
      category: "scratchyg"
    }, {
      id: "scratchyg.isDesktop",
      spec: "Is desktop?",
      inputs: [],
      shape: "boolean",
      category: "scratchyg"
    }, {
      id: "scratchyg.isMobile",
      spec: "Is mobile?",
      inputs: [],
      shape: "boolean",
      category: "scratchyg"
    }, {
      id: "scratchyg.isTablet",
      spec: "Is tablet?",
      inputs: [],
      shape: "boolean",
      category: "scratchyg"
      ...
      id: "scratchyg.getPayingStatus",
      spec: "Player's paying status",
      inputs: [],
      shape: "reporter",
      category: "scratchyg"
    }, {
      id: "scratchyg.loadFlags",
      spec: "Load flags",
      inputs: [],
      shape: "stack",
      category: "scratchyg"
    }, {
      id: "scratchyg.flagsloaded",
      spec: "Are flags loaded?",
      inputs: [],
      shape: "boolean",
      category: "scratchyg"
    }, {
      id: "scratchyg.getFlag",
      spec: "Get flag value %1, defaults to %2",
      inputs: ["%s", "%s"],
      shape: "reporter",
      category: "scratchyg"
    }];
    ...
    var CommentView$1 = /*#__PURE__*/function () {
      ...
      return _createClass(CommentView, [{
        key: "isComment",
        get: function get() {
          return true;
        }
    ...
    var ScriptView$1 = /*#__PURE__*/function () {
      ...
      return _createClass(ScriptView, [{
        key: "isScript",
        get: function get() {
          return true;
        }
    ...
    var DocumentView$1 = /*#__PURE__*/function () {
      ...
      return _createClass(DocumentView, [{
        key: "measure",
        value: function measure() {
          this.scripts.forEach(function (script) {
    ...
    var BlockView = /*#__PURE__*/function () {
      ...
      return _createClass(BlockView, [{
        ...
        value: function draw(iconStyle) {
          ...
          innerWidth = Math.max(this.hasScript ? 160 : this.isHat ? 100 // Correct for Scratch 3.0.
          : this.isCommand || this.isOutline ? 64 : this.isReporter ? 48 : 0, innerWidth);
    ...
    var GlowView = /*#__PURE__*/function () {
      ...
      return _createClass(GlowView, [{
        ...
        key: "drawSelf",
        value: function drawSelf(iconStyle) {
          var c = this.child;
          var el;
          var w = this.width;
          var h = this.height - 1;
