...
scratchblocks.renderMatching('code.sbt', {
    style:     'scratch3',   // Optional, defaults to 'scratch2'.
    languages: ['ru'], // Optional, defaults to ['en'].
    scale: 1.25,                // Optional, defaults to 1
    inline: true
});